...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('products', '0008_remove_producto_marca_remove_producto_subcategoria_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Plataforma',
            fields=[
                ('idPlataforma', models.CharField(max_length=3, primary_key=True, serialize=False, verbose_name='Id de la plataforma')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagenProducto', models.ImageField(upload_to='', verbose_name='Imagen del producto')),
                ('fechaLanProducto', models.DateField(blank=True, null=True, verbose_name='Fecha de lanzamiento del producto')),
